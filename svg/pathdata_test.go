...
func TestPathData(t *testing.T) {
	var pathDataTests = []struct {
		...
		{"M10 10L20 20", "M10 10 20 20"},
		{"M10 10l20 20", "M10 10l20 20"},
		...
		{"ML", ""},
		{".8.00c0", "M.8.0"},
		{".1.04h0e6.0e6.0e0.0", "M.1.04h0 0 0 0"},
		...
		{`m26 33.1-.5 5.3L23 38l-.2 2.7-5.3-.5M15 37.5l-2.6-.2-.5 5.3 5.3.4.4-5.3zl.4-5.3-2.6-.2.4-5.3 5.3.5-.2 2.6 5.2.4.3-2.6 5.2.4-.4 5.3-5.3-.4.2-2.7`, `m26 33.1-.5 5.3L23 38l-.2 2.7-5.3-.5M15 37.5l-2.6-.2-.5 5.3 5.3.4.4-5.3zl.4-5.3-2.6-.2.4-5.3 5.3.5-.2 2.6 5.2.4.3-2.6 5.2.4-.4 5.3-5.3-.4.2-2.7`}, // #1023
	}
