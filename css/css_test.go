...
func TestCSSInline(t *testing.T) {
	cssTests := []struct {
		...
		{"color: rgba(5%,10%,20%,0.1);", "color:rgba(5%,10%,20%,.1)"},
		{"color: rgba(0%,15%,25%,0.2);", "color:rgba(0%,15%,25%,.2)"},
		{"color: rgba(30%,0%,35%,0.3);", "color:rgba(30%,0%,35%,.3)"},
		{"color: rgba(40%,45%,0%,0.4);", "color:rgba(40%,45%,0%,.4)"},
		{"color: rgba(10%,15%,20%,1);", "color:#1a2633"},
		{"color: rgba(50%,55%,60%,0);", "color:transparent"},
		{"color: hsl(10,0%,80%);", "color:#ccc"},
		{"color: hsl(0,50%,0%);", "color:#000"},
		{"color: hsl(1,0%,10%);", "color:#1a1a1a"},
		{"color: hsl(2,20%,20%);", "color:#3d2929"},
		{"color: hsla(3,0%,0%,1);", "color:#000"},
		{"color: hsla(4,0%,20%,1);", "color:#333"},
		{"color: hsla(5,0%,10%,0.75);", "color:hsla(5,0%,10%,.75)"},
		{"color: hsla(6,20%,20%,0.5);", "color:hsla(6,20%,20%,.5)"},
		{"color: hsla(7,20%,0%,0.25);", "color:hsla(7,20%,0%,.25)"},
		{"color: hsla(8,0%,50%,1);", "color:gray"},
