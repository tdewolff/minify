...
func TestCSS(t *testing.T) {
	...
	assertCSS(t, "[class^=icon-] i[class^=icon-],i[class*=\" icon-\"]{x:y}", "[class^=icon-] i[class^=icon-],i[class*=\" icon-\"]{x:y}")
	assertCSS(t, "html{line-height:1;}html{line-height:1;}", "html{line-height:1}html{line-height:1}")
	assertCSS(t, ".clearfix { *zoom: 1; }", ".clearfix{*zoom:1}")
