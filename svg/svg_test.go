...
func TestSVG(t *testing.T) {
	svgTests := []struct {
		...
		{`<path d="M 100 100 L 300 100 L 200 100 z"/>`, `<path d="1e2 1e2H3e2 2e2z"/>`},
		{`<path d="M100 -100M200 300z"/>`, `<path d="1e2-1e2M2e2 3e2z"/>`},
		{`<path d="M0.5 0.6 M -100 0.5z"/>`, `<path d=".5.6M-1e2.5z"/>`},
		{`<path d="M01.0 0.6 z"/>`, `<path d="1 .6z"/>`},
		{`<path d="M20 20l-10-10z"/>`, `<path d="20 20 10 10z"/>`},
