...
func TestCSSInline(t *testing.T) {
	cssTests := []struct {
		...
		{"color: rgba(255,0,0,0.5);", "color:rgb(255,0,0,.5)"},
		{"color: rgba(255,0,0,-1);", "color:transparent"},
		{"color: rgba(0%,15%,25%,0.2);", "color:rgb(0%,15%,25%,.2)"},
		{"color: rgba(0,0,0,0.5);", "color:rgb(0,0,0,.5)"},
		{"color: hsla(5,0%,10%,0.75);", "color:hsl(5,0%,10%,.75)"},
		...
		{"background: hsla(0,0%,100%,.7);", "background:hsl(0,0%,100%,.7)"},
