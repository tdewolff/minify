...
Minify is a minifier package written in [Go][1]. It has build-in HTML5, CSS3, JS, JSON and XML minifiers and provides an interface to implement any minifier. The implemented minifiers are high performance and streaming (which implies O(n)).
