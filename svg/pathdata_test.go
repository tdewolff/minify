...
func TestPathData(t *testing.T) {
	var pathDataTests = []struct {
		...
		{"A1.1.0.0.0.0.2.3", "A1.1.0 00.2.3"},                                // bad input (sweep and large-arc are not booleans) gives bad output
		{"A1.1.0.0.0.0.2.3L10 0", "A1.1.0 00.2.3L10 0"},
		{"A.0.0.4.0.0.0.3", "A0 0 .4 000 3"}, // bad input, keep dot for booleans
		...
		{"A.0.0.0.0.3.2e3.7.0.0.0.0.0.1.3.0.0.0.0.2.3.2.0.0.0.0.20.2e-10.0.0.0.0.0.0.0.0", "A0 0 0 012e2.7.0.0.0.0.0.1.3.0.0.0.0.2.3.2.0.0.0.0.2 2e-11.0.0.0.0.0.0.0.0"}, // bad input (sweep and large-arc are not booleans) gives bad output
		//{
